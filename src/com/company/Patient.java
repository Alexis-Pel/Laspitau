...
public class Patient {
    ...
    public static int nombrePatients = 0;
    ...
    public static void addPatient(){
        try{
            setNombrePatients();
            if (nombrePatients == Hopital.listeHopitaux.get(Hopital.actuelHopital).getTaille()) {
    ...
    public static void setNombrePatients(){
        nombrePatients = 0;
        for (int i = 0; i < listePatients.size(); i++) {
           int hopitalIndex =  listePatients.get(i).getWhichHospital();
            if (hopitalIndex == Hopital.actuelHopital){
                nombrePatients++;
            }
        }
    }
